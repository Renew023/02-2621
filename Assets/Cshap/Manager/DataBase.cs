...
public class DataBase : MonoBehaviour
{
    ...
    public void SkillList(){ //string _No, string _Name, int _Damage, int _shield, string _Explain, string _STAT, int _hitNumber, string _Effect, int _EffectPer, string _SkillType, int _Turn
        Skill.Add(new Skill("0", "강렬한 일격", 120, 0, "강력한 힘으로 상대를 타격합니다.", "ATK", 1, "독성", 50, 1, "Active", 1));
        Skill.Add(new Skill("1", "독바른 쌍연격", 60, 0, "강력한 힘으로 상대를 타격합니다.", "SPD", 2, "불꽃", 80, 2, "Active", 2));
        Skill.Add(new Skill("2", "강철의 심장", 0, 100,"체력을 순간적으로 증폭시킨다.", "DEX", 1, "쉴드", 100, 2, "Active", 2));
    }
    public void PassiveList(){
        Passive.Add(new Skill("0", "대장의 품격", 0, 0, "게임 시작 시 상대에게 데미지를 줍니다", "ATK", 10, "", 0, 0, "Passive", 0));
    }
    ...
    public void StageList(){
        ...
        StageArray.Add(new Stage("2", "언어마술사", "시발", "300", "tlqkf, 기술북"));
    }
    ...
    public void RewardListSum(){
        RewardList = Item.Count + Skill.Count;
